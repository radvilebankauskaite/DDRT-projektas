...
h2o.performance(model980101, newdata = test_data)
...
predictions %>%
  ...
  select(id, y) %>%
  write_csv("C:/Users/Mantas/Downloads/predictions_v.model_gbm2.csv")
...
h2o.saveModel(model_gbm2, "C:/Users/Mantas/Downloads/", filename = "my_model_gbm")

model <- h2o.loadModel("C:/Users/Mantas/Downloads/my_model_gbm")
